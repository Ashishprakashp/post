...
$query1 = "SELECT * FROM jobs where fid=$id";
//echo $query1;
...
<button class="cardbtn" id="$jid" onclick="fetchjob(this.id)">Accept</button>
<button class="cardbtn">Turn down</button>
...
<script>
  function fetchjob(clicked_id)
  {
      ...
      window.location.href = 'job_upload.php';
  }
</script>
</html>