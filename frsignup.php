...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST"  >
    <center><h2>SIGN UP</h2></center><br>
        ...
        Password:&nbsp&nbsp&nbsp<input type="password" name="pass" class="field" id="id_password" required><img src="resources/eye.png" width="20px" class="far fa-eye" id="togglePassword" style="cursor: pointer; margin-right:0px;"><br><br>
        Re-enter Password:&nbsp&nbsp&nbsp<input type="password" name="pass2" class="field" id="id_password1" required><br><br>
        <div >
        ...
        <center>
        <input type="text" id="myInput"  onkeyup="myFunction()" placeholder="Choose skills.." autocomplete="off"></center><br>
<p ></p>
<div id="joblist">
...
<ul id="myUL">
  ...
  <li><label onclick="add('Cindy')"> Cindy</label></li>
        ...
        <center>Already have an account ?&nbsp<a href="http://localhost/project/Login.php">Sign in</center></a><br><br>
...
if(isset($_POST['submit'])&& isset($_SESSION['freelancer'])){
    echo "Success";
    $fna=$_POST['fna'];
    $lna=$_POST['lna'];
    $mail=$_POST['mail'];
    ...
    $check="SELECT * FROM freelancer WHERE mailid='$mail'";  
    ...
    $query = "INSERT INTO freelancer(fname,lname,mailid,code,phone,country,pw,category,question,answer,img) VALUES('$fna','$lna','$mail','$code',$phone,'$country','$encrypt','$category','$encryptques','$encryptans','./uploaded_files/user.png')";
...
function hide(){
  a=document.getElementById("myUL");
  b=document.getElementById("joblist");
