...
<body>
    ...
    <div id="whole">
    <div id="main">
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" <?php if(isset($_SESSION['freelancer'])){echo 'hidden';}?>>
...
> 
        ...
        Phone:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input type="text" name="code" class="code" required>&nbsp&nbsp&nbsp&nbsp<input type="number" name="phone" class="field" required><br><br>
...
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" <?php if(isset($_SESSION['customer'])){echo 'hidden';}?>>
    <center><h2>SIGN UP</h2></center><br>
...
<ul id="myUL">
  ...
  <li><label onclick="add('Agnes')"> Agnes</label></li>
